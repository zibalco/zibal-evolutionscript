...
echo "\" onsubmit=\"return submitform(this.id);\">
	<table width=\"100%\" class=\"widget-tbl\">
    	<tr>
        	<td align=\"right\" width=\"200\">مرچنت زیبال : </td>
...
echo $r['min_deposit'];
echo "\" /> (توجه : پرداخت مبلغ کمتر از 100 تومان از طریق زیبال امکان پذیر نمی باشد)</td>
        </tr>
    	<tr>
        	<td align=\"right\">اجازه درخواست تسویه حساب از طریق زیبال</td>
